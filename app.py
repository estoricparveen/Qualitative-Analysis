...
# OpenAI API Function (Updated to match new OpenAI format)
...
with st.sidebar:
    ...
    api_choice = st.radio("Select AI Model:", ["OpenAI", "Google Gemini"])
    ...
    if not st.session_state.api_key:
        ...
        with st.spinner("Analyzing your data..."):
            ...
            if st.session_state.api_choice == "OpenAI":
                ...
                qualitative_insights = process_with_openai(user_question, qualitative_data, "Provide qualitative insights and key takeaways.")
            else:
                summary = process_with_gemini(user_question, qualitative_data, "Summarize the key themes and main points from the text.")
                qualitative_insights = process_with_gemini(user_question, qualitative_data, "Provide qualitative insights and key takeaways.")
            
            st.write("**Summary:**")
            st.write(summary)
            
            st.write("**Qualitative Analysis:**")
            st.write(qualitative_insights)
